...
class MedicineList extends React.Component {
  ...
  validateMedicineDetails() {
    ...
    if (medicineName === '') {
      ...
      this.addMedicine(medicineName,dosage,medicineType,startTime,dosageInterval);
    }
  }

  addMedicine(medicineName,dosage,medicineType,startTime,dosageInterval) {
    let medicineDetails = {
    ...
    store.dispatch({type: 'ADD_MEDICINE', medicineDetails: medicineDetails});
    ...
    firestore()
      ...
      .add(medicineDetails)
      .then(() => {
        console.log('A Medicine reminder is added!');
      });
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          <TextInput
            ...
            ref={input => this.medicineNameRef = input}
          />
          ...
          <TextInput
            ...
            ref={input => this.dosageRef = input}
          ...
          <View style={styles.typeContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>this.setState({medicineType: 'BOTTLE', medicineTypeError: ''})}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() =>this.setState({medicineType: 'PILL', medicineTypeError: ''})}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() =>this.setState({medicineType: 'SYRINGE', medicineTypeError: ''})}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() =>this.setState({medicineType: 'TABLET', medicineTypeError: ''})}
            >
          ...
          {this.state.medicineTypeError !== '' && (<Text style={styles.error}>{this.state.medicineTypeError}</Text>)}
          ...
          />
          {this.state.startTimeError !== '' && (<Text style={styles.error}>{this.state.startTimeError}</Text>)}
