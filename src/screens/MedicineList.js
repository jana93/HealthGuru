  ...
  getMedicine() {
    firestore()
      ...
      .then(snapshot => {
        ...
        store.dispatch({type: 'GET_MEDICINE_LIST', medicineList: medicineList});
    ...
    return (
      <View style={{flex: 1}}>
            ...
            {this.props.medicineList.length === 0 ? (
              <View style={styles.container}>
                <Text
                  ...
                  There are no medicines, please add
                </Text>
              </View>
            ) : (
              <View style={styles.container}>
                <FlatList
                  ...
                  renderItem={({item, index}) =>
                    this.renderMedicineCard(item, index)
                  }
        ...
        <TouchableOpacity
          ...
          <Image
            source={PLUS_IMAGE}
            style={{height: 21, width: 21, tintColor: 'white'}}
          />
        </TouchableOpacity>
      </View>
    );
